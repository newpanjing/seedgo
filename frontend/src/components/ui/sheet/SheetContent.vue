...
<template>
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        class="absolute right-4 top-4 rounded-full bg-secondary p-2 text-secondary-foreground transition-all hover:bg-secondary/80 active:scale-90 focus:outline-none disabled:pointer-events-none"
      >
        <X class="h-4 w-4" />
